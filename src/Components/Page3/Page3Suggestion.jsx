...
const Page3Suggestion = () => {
  return (
    <div className='w-full h-[15vh] px-20 my-14 flex items-center  justify-evenly'>
        ...
        <h4 className='font-semibold text-xl px-8 py-4 rounded-xl border-2'>Holidays</h4>
        <h4 className='font-semibold text-xl px-8 py-4 rounded-xl border-2'>Trains</h4>
        <h4 className='font-semibold text-xl px-8 py-4 rounded-xl border-2'>Others</h4>
    </div>
  )
}

export default Page3Suggestion